...
local function run_entity_with_sim_control()
    ...
    print("   Added NPC 2: vehicle=" .. npc2.vehicle)
    print("   Added Player: vehicle=" .. player.vehicle)
    ...
    print("   Moved NPC 1 (vehicle=" .. npc1.vehicle .. ") to (5.0, 5.0)")
    ...
    print("   Moved NPC 2 (vehicle=" .. npc2.vehicle .. ") to (15.0, 15.0) while paused")
    sim.resume()
    print("")
    ...
    for i, entity in ipairs(all_entities) do
        print("   Entity " .. i .. ": vehicle=" .. entity.id.vehicle .. " (type: " .. entity.type .. ")")
    end
    print("")
